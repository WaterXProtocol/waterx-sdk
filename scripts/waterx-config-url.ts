...
export function isLegacyConfigFileUrl(raw: string): boolean {
...
/** Test-only: forget that the deprecation warning has fired. */
export function resetLegacyConfigUrlWarning(): void {
  warnedLegacyFileUrl = false;
}
