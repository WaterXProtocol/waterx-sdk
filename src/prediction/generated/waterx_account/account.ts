...
export const ACCOUNT: MoveStruct<any, any> = new MoveStruct({ name: `${$moduleName}::ACCOUNT`, fields: {
        dummy_field: bcs.bool()
    } });
export const AdminCap: MoveStruct<any, any> = new MoveStruct({ name: `${$moduleName}::AdminCap`, fields: {
        id: bcs.Address
    } });
export const WaterXAccount: MoveStruct<any, any> = new MoveStruct({ name: `${$moduleName}::WaterXAccount`, fields: {
        dummy_field: bcs.bool()
    } });
export const AccountRegistry: MoveStruct<any, any> = new MoveStruct({ name: `${$moduleName}::AccountRegistry`, fields: {
        id: bcs.Address,
        /**
...
export const Vault: MoveStruct<any, any> = new MoveStruct({ name: `${$moduleName}::Vault<phantom T>`, fields: {
...
export const Delegate: MoveStruct<any, any> = new MoveStruct({ name: `${$moduleName}::Delegate`, fields: {
...
export const DepositRequest: MoveStruct<any, any> = new MoveStruct({ name: `${$moduleName}::DepositRequest<phantom T>`, fields: {
        account_id: bcs.Address,
        balance: balance_1.Balance,
        extra_data: bcs.vector(bcs.u8())
    } });
export const WithdrawRequest: MoveStruct<any, any> = new MoveStruct({ name: `${$moduleName}::WithdrawRequest<phantom T>`, fields: {
        account_id: bcs.Address,
        balance: balance_1.Balance,
...
export const AccountKey: MoveStruct<any, any> = new MoveStruct({ name: `${$moduleName}::AccountKey`, fields: {
        owner: bcs.Address,
        index: bcs.u64()
    } });
