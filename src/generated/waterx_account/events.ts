...
export const TypeAllowed = new MoveStruct({ name: `${$moduleName}::TypeAllowed`, fields: {
        type_name: type_name_4.TypeName
    } });
export const TypeDisallowed = new MoveStruct({ name: `${$moduleName}::TypeDisallowed`, fields: {
        type_name: type_name_5.TypeName
    } });
...
export const ReturnedByProtocol = new MoveStruct({ name: `${$moduleName}::ReturnedByProtocol`, fields: {
        account_object_address: bcs.Address,
        protocol: type_name_20.TypeName,
