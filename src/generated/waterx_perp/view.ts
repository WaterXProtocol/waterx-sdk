...
const $moduleName = '@waterx/perp::view';
export const DelegateData = new MoveStruct({ name: `${$moduleName}::DelegateData`, fields: {
...
export const AccountData = new MoveStruct({ name: `${$moduleName}::AccountData`, fields: {
        ...
        delegates: bcs.vector(DelegateData)
    } });
...
export const OrderData = new MoveStruct({ name: `${$moduleName}::OrderData`, fields: {
        ...
        size: bcs.u128(),
        collateral_type: type_name_6.TypeName,
        collateral_amount: bcs.u64(),
        collateral_decimal: bcs.u8(),
...
/** Get all accounts for an address, including delegates. */
...
export function positionData(options: PositionDataOptions) {
    ...
    const parameterNames = ["market", "pool", "basePriceUsd", "collateralPriceUsd", "positionId"];
    return (tx: Transaction) => tx.moveCall({
        package: packageAddress,
        module: 'view',
...
export interface PositionDataInternalArguments {
...
export interface PositionDataInternalOptions {
    package?: string;
    arguments: PositionDataInternalArguments | [
        p: RawTransactionArgument<string>,
        m: RawTransactionArgument<string>,
        pool: RawTransactionArgument<string>,
        basePriceUsd: RawTransactionArgument<number | bigint>,
...
export function positionDataInternal(options: PositionDataInternalOptions) {
    const packageAddress = options.package ?? '@waterx/perp';
    const argumentsTypes = [
        null,
        null,
    ...
    const parameterNames = ["p", "m", "pool", "basePriceUsd", "collateralPriceUsd"];
    return (tx: Transaction) => tx.moveCall({
        package: packageAddress,
        module: 'view',
        function: 'position_data_internal',
        arguments: normalizeMoveArguments(options.arguments, argumentsTypes, parameterNames),
        typeArguments: options.typeArguments
    });
}
export interface BuildOrderDataArguments {
    o: RawTransactionArgument<string>;
    oraclePriceScaled: RawTransactionArgument<number | bigint>;
}
export interface BuildOrderDataOptions {
    package?: string;
    arguments: BuildOrderDataArguments | [
        o: RawTransactionArgument<string>,
        oraclePriceScaled: RawTransactionArgument<number | bigint>
    ];
}
/** Internal builder for OrderData — both direct lookups and scans use this. */
export function buildOrderData(options: BuildOrderDataOptions) {
    const packageAddress = options.package ?? '@waterx/perp';
    const argumentsTypes = [
        null,
        'u128'
    ] satisfies (string | null)[];
    const parameterNames = ["o", "oraclePriceScaled"];
    return (tx: Transaction) => tx.moveCall({
        package: packageAddress,
        module: 'view',
        function: 'build_order_data',
        arguments: normalizeMoveArguments(options.arguments, argumentsTypes, parameterNames),
    });
}
...
export function orderData(options: OrderDataOptions) {
    ...
    const parameterNames = ["market", "basePriceUsd", "orderTypeTag", "triggerPrice", "orderId"];
    return (tx: Transaction) => tx.moveCall({
        package: packageAddress,
        module: 'view',
        function: 'order_data',
...
export function getAccountPositions(options: GetAccountPositionsOptions) {
    ...
    const parameterNames = ["market", "pool", "registry", "basePriceUsd", "collateralPriceUsd", "accountObjectAddress"];
    return (tx: Transaction) => tx.moveCall({
        package: packageAddress,
        module: 'view',
...
export function getAccountOrders(options: GetAccountOrdersOptions) {
    ...
    const parameterNames = ["market", "basePriceUsd", "accountObjectAddress"];
    return (tx: Transaction) => tx.moveCall({
        package: packageAddress,
        module: 'view',
...
export function getMarketOrders(options: GetMarketOrdersOptions) {
    ...
    const parameterNames = ["market", "basePriceUsd", "cursor", "pageSize"];
    return (tx: Transaction) => tx.moveCall({
        package: packageAddress,
        module: 'view',
...
export function getMarketPositions(options: GetMarketPositionsOptions) {
    ...
    const parameterNames = ["market", "pool", "basePriceUsd", "collateralPriceUsd", "cursor", "pageSize"];
    return (tx: Transaction) => tx.moveCall({
        package: packageAddress,
        module: 'view',
...
export interface CalculateEstLiqPriceArguments {
    p: RawTransactionArgument<string>;
...
export interface CalculateEstLiqPriceOptions {
    package?: string;
    arguments: CalculateEstLiqPriceArguments | [
        p: RawTransactionArgument<string>,
        basePrice: RawTransactionArgument<string>,
        collateralPrice: RawTransactionArgument<string>,
        maintenanceMarginBps: RawTransactionArgument<number | bigint>,
...
/**
 * Estimates the liquidation price for a position. Long: liq = avgPrice × (1 −
 * (collateral_usd − fees_usd − maintenance) / entry_notional) Short: liq =
 * avgPrice × (1 + (collateral_usd − fees_usd − maintenance) / entry_notional)
 */
export function calculateEstLiqPrice(options: CalculateEstLiqPriceOptions) {
    const packageAddress = options.package ?? '@waterx/perp';
    const argumentsTypes = [
        null,
        null,
    ...
    const parameterNames = ["p", "basePrice", "collateralPrice", "maintenanceMarginBps", "borrowFee", "fundingSign", "fundingFee", "tradingFee"];
    return (tx: Transaction) => tx.moveCall({
        package: packageAddress,
        module: 'view',
        function: 'calculate_est_liq_price',
        arguments: normalizeMoveArguments(options.arguments, argumentsTypes, parameterNames),
    });
}