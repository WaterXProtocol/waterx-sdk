...
export interface EmitWlpMintedArguments {
    minterAddress: RawTransactionArgument<string>;
    wlpType: RawTransactionArgument<string>;
    tokenType: RawTransactionArgument<string>;
...
export function emitWlpMinted(options: EmitWlpMintedOptions) {
    ...
    const parameterNames = ["minterAddress", "wlpType", "tokenType", "depositAmount", "wlpAmount", "feeAmount", "sharePrice"];
    return (tx: Transaction) => tx.moveCall({
        package: packageAddress,
        module: 'events',
...
export function emitWlpRedeemRequested(options: EmitWlpRedeemRequestedOptions) {
    ...
    const parameterNames = ["userAddress", "wlpType", "tokenType", "wlpAmount", "requestId"];
    return (tx: Transaction) => tx.moveCall({
        package: packageAddress,
        module: 'events',
...
export function emitWlpRedeemCancelled(options: EmitWlpRedeemCancelledOptions) {
    ...
    const parameterNames = ["userAddress", "wlpType", "tokenType", "requestId", "wlpAmount"];
    return (tx: Transaction) => tx.moveCall({
        package: packageAddress,
        module: 'events',
...
export function emitWlpRedeemRejected(options: EmitWlpRedeemRejectedOptions) {
    ...
    const parameterNames = ["userAddress", "operatorAddress", "wlpType", "tokenType", "requestId", "wlpAmount"];
    return (tx: Transaction) => tx.moveCall({
        package: packageAddress,
        module: 'events',
...
export function emitWlpRedeemSettled(options: EmitWlpRedeemSettledOptions) {
    ...
    const parameterNames = ["userAddress", "wlpType", "tokenType", "requestId", "redeemAmount", "feeAmount", "sharePrice"];
    return (tx: Transaction) => tx.moveCall({
        package: packageAddress,
        module: 'events',
