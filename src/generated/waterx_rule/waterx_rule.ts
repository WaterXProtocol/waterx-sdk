...
export const WATERX_RULE = new MoveStruct({
  name: `${$moduleName}::WATERX_RULE`,
  fields: {
    dummy_field: bcs.bool(),
  },
});
export const WaterxRule = new MoveStruct({
  name: `${$moduleName}::WaterxRule`,
  fields: {
    dummy_field: bcs.bool(),
  },
});
export const PricePayload = new MoveStruct({
  name: `${$moduleName}::PricePayload`,
  fields: {
    ticker: bcs.string(),
...
export const BatchPriceItem = new MoveStruct({
  name: `${$moduleName}::BatchPriceItem`,
  fields: {
    symbol: bcs.string(),
    ticker: bcs.string(),
    sources: bcs.vector(bcs.u64()),
...
export const BatchPricePayload = new MoveStruct({
  name: `${$moduleName}::BatchPricePayload`,
  fields: {
    items: bcs.vector(BatchPriceItem),
  },
});
export const MerkleRoot = new MoveStruct({
  name: `${$moduleName}::MerkleRoot`,
  fields: {
    root: bcs.vector(bcs.u8()),
  },
});
export const FeedConfig = new MoveStruct({
  name: `${$moduleName}::FeedConfig`,
  fields: {
    ticker: bcs.string(),
    sources: bcs.vector(bcs.u64()),
    method: bcs.string(),
...
export const VerifiedPrice = new MoveStruct({
  name: `${$moduleName}::VerifiedPrice`,
  fields: {
    symbol: bcs.string(),
    ticker: bcs.string(),
    sources: bcs.vector(bcs.u64()),
...
export const SignedTsHwmKey = new MoveStruct({
  name: `${$moduleName}::SignedTsHwmKey`,
  fields: {
    symbol: bcs.string(),
  },
});
export const HistoricalPriceVerified = new MoveStruct({
  name: `${$moduleName}::HistoricalPriceVerified`,
  fields: {
    symbol: bcs.string(),
    ticker: bcs.string(),
    sources: bcs.vector(bcs.u64()),
...
export const BatchLatestUpdated = new MoveStruct({
  name: `${$moduleName}::BatchLatestUpdated`,
  fields: {
    count: bcs.u64(),
 ...
 * *freshness* miss ABSTAINS (records `none`, which `aggregator::remove_outliers`
 * drops before the `weight_threshold` fail-closed check). A *config/integrity*
 ...
 * and replay always abort (`EReplayedSignature` — audit F-014: a signed tuple is
 * single-use per symbol; doc synced to the Move source post-F-014, an earlier
 * draft here wrongly described replay as abstaining).
 *
...
export interface CollectSingleWithProofOptions {
  package?: string;
  arguments:
    | CollectSingleWithProofArguments
    | [
        collector: TransactionArgument,
        config: RawTransactionArgument<string>,
        enclaveConfig: RawTransactionArgument<string>,
...
export interface DestroyVerifiedPriceOptions {
  package?: string;
  arguments: DestroyVerifiedPriceArguments | [price: TransactionArgument];
}
/**
...
export interface CollectVerifiedPriceOptions {
  package?: string;
  arguments:
    CollectVerifiedPriceArguments | [collector: TransactionArgument, price: TransactionArgument];
}
/**
...
export interface PushBatchItemOptions {
  package?: string;
  arguments: PushBatchItemArguments | [payload: TransactionArgument, item: TransactionArgument];
}
...
export interface FeedConfigOptions {
  ...
  arguments:
    | FeedConfigArguments
    | [config: RawTransactionArgument<string>, symbol: RawTransactionArgument<string>];
}
...
export interface LeafHashOfOptions {
  package?: string;
  arguments: LeafHashOfArguments | [item: TransactionArgument];
}
/**
...
export interface BatchItemsOptions {
  package?: string;
  arguments: BatchItemsArguments | [payload: TransactionArgument];
}
...
export interface BatchItemSymbolOptions {
  package?: string;
  arguments: BatchItemSymbolArguments | [item: TransactionArgument];
}
...
export interface BatchItemTickerOptions {
  package?: string;
  arguments: BatchItemTickerArguments | [item: TransactionArgument];
}
...
export interface BatchItemSourcesOptions {
  package?: string;
  arguments: BatchItemSourcesArguments | [item: TransactionArgument];
}
...
export interface BatchItemMethodOptions {
  package?: string;
  arguments: BatchItemMethodArguments | [item: TransactionArgument];
}
...
export interface BatchItemPriceTimestampMsOptions {
  package?: string;
  arguments: BatchItemPriceTimestampMsArguments | [item: TransactionArgument];
}
...
export interface BatchItemPriceNOptions {
  package?: string;
  arguments: BatchItemPriceNArguments | [item: TransactionArgument];
}
...
export interface BatchItemPriceScaleOptions {
  package?: string;
  arguments: BatchItemPriceScaleArguments | [item: TransactionArgument];
}
...
export interface BatchItemConfidenceNOptions {
  package?: string;
  arguments: BatchItemConfidenceNArguments | [item: TransactionArgument];
}
...
export interface BatchItemConfidenceScaleOptions {
  package?: string;
  arguments: BatchItemConfidenceScaleArguments | [item: TransactionArgument];
}
...
export interface BatchItemMaxSourceDeviationBpsOptions {
  package?: string;
  arguments: BatchItemMaxSourceDeviationBpsArguments | [item: TransactionArgument];
}
...
export interface BatchItemNumSourcesOptions {
  package?: string;
  arguments: BatchItemNumSourcesArguments | [item: TransactionArgument];
}
...
export interface VerifiedSymbolOptions {
  package?: string;
  arguments: VerifiedSymbolArguments | [price: TransactionArgument];
}
...
export interface VerifiedTickerOptions {
  package?: string;
  arguments: VerifiedTickerArguments | [price: TransactionArgument];
}
...
export interface VerifiedSourcesOptions {
  package?: string;
  arguments: VerifiedSourcesArguments | [price: TransactionArgument];
}
...
export interface VerifiedMethodOptions {
  package?: string;
  arguments: VerifiedMethodArguments | [price: TransactionArgument];
}
...
export interface VerifiedPriceTimestampMsOptions {
  package?: string;
  arguments: VerifiedPriceTimestampMsArguments | [price: TransactionArgument];
}
...
export interface VerifiedPriceOptions {
  package?: string;
  arguments: VerifiedPriceArguments | [price: TransactionArgument];
}
...
export interface VerifiedPriceScaledOptions {
  package?: string;
  arguments: VerifiedPriceScaledArguments | [price: TransactionArgument];
}
...
export interface VerifiedPriceNOptions {
  package?: string;
  arguments: VerifiedPriceNArguments | [price: TransactionArgument];
}
...
export interface VerifiedPriceScaleOptions {
  package?: string;
  arguments: VerifiedPriceScaleArguments | [price: TransactionArgument];
}
...
export interface VerifiedConfidenceNOptions {
  package?: string;
  arguments: VerifiedConfidenceNArguments | [price: TransactionArgument];
}
...
export interface VerifiedConfidenceScaleOptions {
  package?: string;
  arguments: VerifiedConfidenceScaleArguments | [price: TransactionArgument];
}
...
export interface VerifiedMaxSourceDeviationBpsOptions {
  package?: string;
  arguments: VerifiedMaxSourceDeviationBpsArguments | [price: TransactionArgument];
}
...
export interface VerifiedNumSourcesOptions {
  package?: string;
  arguments: VerifiedNumSourcesArguments | [price: TransactionArgument];
}
...
export interface VerifiedSignedTimestampMsOptions {
  package?: string;
  arguments: VerifiedSignedTimestampMsArguments | [price: TransactionArgument];
}
...
export interface IsSupportedSourceOptions {
  package?: string;
  arguments: IsSupportedSourceArguments | [source: RawTransactionArgument<number | bigint>];
}
...
export interface IsPerpSourceOptions {
  package?: string;
  arguments: IsPerpSourceArguments | [source: RawTransactionArgument<number | bigint>];
}
...
export interface IsSupportedMethodOptions {
  package?: string;
  arguments: IsSupportedMethodArguments | [method: RawTransactionArgument<string>];
}
...
export interface IsPerpMethodOptions {
  package?: string;
  arguments: IsPerpMethodArguments | [method: RawTransactionArgument<string>];
}
...
export interface SourceFromNameOptions {
  package?: string;
  arguments: SourceFromNameArguments | [name: RawTransactionArgument<string>];
}
...
export interface MethodFromNameOptions {
  package?: string;
  arguments: MethodFromNameArguments | [name: RawTransactionArgument<string>];
}
