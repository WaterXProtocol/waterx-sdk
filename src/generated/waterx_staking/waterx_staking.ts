...
export interface PermDepositStakeOptions {
    package?: string;
    arguments?: [
    ];
}
export function permDepositStake(options: PermDepositStakeOptions = {}) {
    const packageAddress = options.package ?? '@waterx/staking';
    return (tx: Transaction) => tx.moveCall({
        package: packageAddress,
        module: 'waterx_staking',
...
export interface PermRedeemStakeOptions {
    package?: string;
    arguments?: [
    ];
}
export function permRedeemStake(options: PermRedeemStakeOptions = {}) {
    const packageAddress = options.package ?? '@waterx/staking';
    return (tx: Transaction) => tx.moveCall({
        package: packageAddress,
        module: 'waterx_staking',
...
export interface PermClaimRewardOptions {
    package?: string;
    arguments?: [
    ];
}
export function permClaimReward(options: PermClaimRewardOptions = {}) {
    const packageAddress = options.package ?? '@waterx/staking';
    return (tx: Transaction) => tx.moveCall({
        package: packageAddress,
        module: 'waterx_staking',
