...
| ------------------------------------------ | --------------------------------------------------------------------------------------------------------------- | ---------------------------------------- | ------------------------------------------------------ | ---------------------------- |
| `OrderPlaced`                              | [`placeOrder`](../../src/prediction/prediction.ts) / [`adminPlaceOrderFor`](../../src/prediction/prediction.ts) | [e2e/order.test.ts](e2e/order.test.ts)   | [integration/order.test.ts](integration/order.test.ts) | owner (admin variant: admin) |
| `OrderFilled`                              | [`fillOrder`](../../src/prediction/prediction.ts)                                                               | [e2e/order.test.ts](e2e/order.test.ts)   | [integration/order.test.ts](integration/order.test.ts) | keeper                       |
| `OrderCancelled`                           | [`selfCancelOrder`](../../src/prediction/prediction.ts) / [`cancelOrder`](../../src/prediction/prediction.ts)   | [e2e/order.test.ts](e2e/order.test.ts)   | [integration/order.test.ts](integration/order.test.ts) | owner / keeper               |
| `CloseRequested`                           | [`requestClose`](../../src/prediction/prediction.ts)                                                            | [e2e/close.test.ts](e2e/close.test.ts)   | [integration/close.test.ts](integration/close.test.ts) | owner                        |
| `CloseConfirmed`                           | [`confirmClose`](../../src/prediction/prediction.ts)                                                            | [e2e/close.test.ts](e2e/close.test.ts)   | [integration/close.test.ts](integration/close.test.ts) | keeper                       |
| `CloseCancelled`                           | [`selfCancelClose`](../../src/prediction/prediction.ts) / [`cancelClose`](../../src/prediction/prediction.ts)   | [e2e/close.test.ts](e2e/close.test.ts)   | [integration/close.test.ts](integration/close.test.ts) | owner / keeper               |
| `PositionClaimed`                          | [`claim`](../../src/prediction/prediction.ts) / [`forceClaim`](../../src/prediction/prediction.ts)              | [e2e/claim.test.ts](e2e/claim.test.ts)   | [integration/claim.test.ts](integration/claim.test.ts) | owner / keeper               |
| `MarketResolved`                           | [`resolveMarket`](../../src/prediction/prediction.ts)                                                           | [e2e/market.test.ts](e2e/market.test.ts) | [integration/claim.test.ts](integration/claim.test.ts) | keeper                       |
| `MarketPaused` / `MarketUnpaused`          | [`pauseMarket`](../../src/prediction/admin.ts) / [`unpauseMarket`](../../src/prediction/admin.ts)               | [e2e/admin.test.ts](e2e/admin.test.ts)   | [integration/admin.test.ts](integration/admin.test.ts) | admin                        |
| `MarketRegistryWithdrawn`                  | [`adminWithdraw`](../../src/prediction/admin.ts)                                                                | [e2e/admin.test.ts](e2e/admin.test.ts)   | [integration/admin.test.ts](integration/admin.test.ts) | admin                        |
| `MinReserveUpdated`                        | [`setMinReserve`](../../src/prediction/admin.ts)                                                                | [e2e/admin.test.ts](e2e/admin.test.ts)   | [integration/admin.test.ts](integration/admin.test.ts) | admin                        |
| `OrderCancelCooldownUpdated`               | [`setOrderCancelCooldownMs`](../../src/prediction/admin.ts)                                                     | [e2e/admin.test.ts](e2e/admin.test.ts)   | [integration/admin.test.ts](integration/admin.test.ts) | admin                        |
| `KeeperAdded` / `KeeperRemoved`            | [`addKeeper`](../../src/prediction/admin.ts) / [`removeKeeper`](../../src/prediction/admin.ts)                  | [e2e/admin.test.ts](e2e/admin.test.ts)   | [integration/admin.test.ts](integration/admin.test.ts) | admin                        |
| (`depositSettlement` — no event by design) | [`depositSettlement`](../../src/prediction/admin.ts)                                                            | [e2e/admin.test.ts](e2e/admin.test.ts)   | [integration/admin.test.ts](integration/admin.test.ts) | admin                        |
