...
- **Oracle:** Lazer / quote-center signed updates via **`refreshOraclePrices`** (`src/oracle/aggregate.ts`). There is **no** legacy bucket-aggregator prime step and no Hermes warm step.
